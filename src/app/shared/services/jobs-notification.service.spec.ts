...
export class MockStore {
  public select(): Observable<boolean> { // todo: mock store correctly
...
describe('Jobs notification service', () => {
  ...
  it(
    ...
    inject([JobsNotificationService], jobsNotificationService => {
